  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
      ...
      @foreach($transactions as $transaction)
              <div class="col-md-6 col-md-offset-3" style="background: white; margin-top: -10%; font-weight: bold">
                  <table class="table">
                    <tr>
                    ...
                    <tr>
                      <td>Merchant Unique Code:</td>
                      <td>{{$transaction->clientunique_id}}</td>
                    </tr>

                    <tr>
                      <td>Gateway Unique Code:</td>
                      <td>{{$transaction->gatewaytrxn_id}}</td>
                    </tr>
                    ...
                    <tr>
                      <td></td>
                      <td>
                        <form name="refund" action="{{route('postrefreq')}}" method="POST">
                          <input type="hidden" name="_token" value="{{csrf_token()}}">
